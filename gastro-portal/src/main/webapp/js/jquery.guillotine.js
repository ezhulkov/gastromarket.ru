    ...
    Guillotine = (function () {
        ...
        Guillotine.prototype._offset = function (left, top) {
            if (left || left === 0) {
                ...
                if (left < 0) this.canvas.style.left = (-left / 2 * 100).toFixed(2) + '%';
                else this.canvas.style.left = (-left * 100).toFixed(2) + '%';
                this.left = left;
            ...
            if (top || top === 0) {
                ...
                if (top < 0)this.canvas.style.top = (-top / 2 * 100).toFixed(2) + '%';
                else this.canvas.style.top = (-top * 100).toFixed(2) + '%';
                this.top = top;
        ...
        Guillotine.prototype._zoom = function (factor) {
            ...
            if (w * factor <= 1) left = -(100 - (this.width * 100).toFixed(2)) / 200;
            if (h * factor <= 1) top = -(100 - (this.height * 100).toFixed(2)) / 200;
            return this._offset(left, top);
        };
