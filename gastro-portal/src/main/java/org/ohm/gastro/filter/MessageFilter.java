            ...
            if (authenticatedUserOpt.isPresent()) {
                ...
                if (httpServletRequest.getMethod().equals("GET")) {
                    ...
                    synchronized (MessageFilter.class) {
                        if (httpServletRequest.getSession(false).getAttribute("posting") == null) {
                            try {
                                httpServletRequest.getSession(false).setAttribute("posting", true);
                                final Long aid = Long.parseLong(httpServletRequest.getParameter("aid"));
                                final Long oid = Long.parseLong(httpServletRequest.getParameter("oid"));
                                ...
                                httpServletRequest.getSession(false).removeAttribute("posting");
                            }
                        }
                    }
                }
