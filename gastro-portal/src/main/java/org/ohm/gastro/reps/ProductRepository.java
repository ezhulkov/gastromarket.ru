...
public interface ProductRepository extends JpaRepository<ProductEntity, Long> {
    ...
    @Query("from ProductEntity pr " +
            ...
            "order by pr.id desc")
    List<ProductEntity> findAllByCategoryAndCatalog(@Param("category") CategoryEntity category, @Param("catalog") CatalogEntity catalog, @Param("hidden") Boolean hidden, Pageable page);
    ...
    @Query("select pr from ProductEntity pr " +
            ...
            "      (pr.hidden=false or :hidden is null) " +
            "order by pr.id desc")
    List<ProductEntity> findAllByParentCategory(@Param("category") CategoryEntity parentCategory, @Param("hidden") Boolean hidden, Pageable page);
