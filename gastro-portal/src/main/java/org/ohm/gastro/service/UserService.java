...
public interface UserService extends UserDetailsService, ImageUploaderService {
    ...
    void processApplicationRequest(String eMail, Region region, String fullName, String about, String sourceInfo, final String catalogName, final String catalogLink);
