...
public interface ConversationService {
    ...
    CommentEntity rateCook(OrderEntity order, final int totalPrice, final int deliveryPrice, String comment, Boolean like, String gmComment, Boolean gmRecommend, UserEntity caller);
