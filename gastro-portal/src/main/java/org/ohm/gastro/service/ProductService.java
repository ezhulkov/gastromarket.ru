...
public interface ProductService extends ImageUploaderService, AltIdService<ProductEntity, ProductRepository> {
    ...
    void saveProduct(ProductEntity product, List<PropertyValueEntity> addValues, List<PropertyValueEntity> delValues);
    ...
    List<ProductEntity> findPromotedProducts(Region region);
