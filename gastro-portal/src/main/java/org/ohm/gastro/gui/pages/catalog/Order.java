...
public class Order extends AbstractPage {
    ...
    @Component(id = "orderInfoAjaxForm")
    private Form orderInfoAjaxForm;
    ...
    public void onPrepareFromOrderInfoAjaxForm() {
    ...
    public Object onSubmitFromOrderInfoAjaxForm() {
        photos = injectPhotos.getSubmittedPhotos();
        if (orderInfoAjaxForm.getHasErrors() || mobile == null || order.getDueDate() == null) {
            error = true;
