...
public class Index extends AbstractCatalogPage {
    ...
    public java.util.List<ProductEntity> getProducts() {
        ...
        java.util.List<ProductEntity> selectedProducts = allProducts.stream().filter(t -> Boolean.TRUE.equals(t.getCatalogPage())).collect(Collectors.toList());
        return (selectedProducts.isEmpty() ? allProducts : selectedProducts).stream().limit(4).collect(Collectors.toList());
    }
